...
import { GAMES, HERO_SLIDES, PROMOS, WINNERS, TOURNAMENTS, RECENTLY_PLAYED, PROVIDERS } from './data';
...
function Sports() {
  const matches = [
  { league: 'Champions League', home: 'Real Madrid', away: 'Bayern', start: 'Today · 20:00', odds: ['1.85', '3.40', '4.20'], live: true, score: '1 - 0', min: '34\'' },
...
/* expose */
export { Sidebar, MobileNav, TopBar, PromoRibbon, Hero, RewardsBanner, Promos, Rail, CategoryView, FilteredGrid, Leaderboard, Tournaments, Sports, Promotion, Providers, Footer, GameModal, CustomerServiceModal, SignInModal };
